...
while(1):
    ...
    if frame_count == 100:
        ...
        cv.imwrite('./Electiva_III/imagenes/camshift_fr_{}.png'.format(frame_count), concatenated_image)
    ...
    if k == 27:
        ...
        cv.imwrite('./Electiva_III/imagenes/opticalfb1_cam.png', frame2)
        cv.imwrite('./Electiva_III/imagenes/opticalhsv_cam.png', bgr)
    prvs = next
